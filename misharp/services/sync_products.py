...
from ..repositories import finish_sync_run, replace_alerts_for_day, replace_product_sales_for_day, start_sync_run, upsert_daily
...
def sync_product_sales(day: date) -> int:
    ...
    with session_scope() as db:
        ...
        try:
            ...
            daily = upsert_daily(db, day,
                product_views=total_views, add_cart_count=total_carts, product_order_count=total_orders,
